<%@ Control Language="VB" AutoEventWireup="false" CodeFile="UserProfileForm.ascx.vb"
    Inherits="WebUserControls_UserProfileForm" %>
...
<script type="text/javascript">
    ...
    function ValidatePassword(sender, args) {
        args.IsValid = (document.getElementById("<%=txtPassword2.ClientID %>").value == document.getElementById("<%=txtPassword.ClientID %>").value);
    }
    ...
    function ValidateType(sender, args) {
        args.IsValid = !(document.getElementById("<%=ddlPractType.ClientID %>").value == "");
    }
    ...
    function ValidateConsent(sender, args) {
        args.IsValid = (document.getElementById("<%=cbConsent.ClientID %>").checked);
    }
    ...
    <table class="new f14" style="width: 100%" cellspacing="0">
        ...
        <tr>
            <td style="width: 100px">
                Username:<asp:RequiredFieldValidator ID="rvUsername" runat="server" ControlToValidate="txtUsername"
                    ErrorMessage="Please Input Your Username" ValidationGroup="UserProfileForm">*</asp:RequiredFieldValidator><asp:CustomValidator
                        ID="validatorUsername" runat="server" ErrorMessage="This Username Is Already Taken"
                        ControlToValidate="txtUsername" ValidationGroup="UserProfileForm" EnableClientScript="false">*</asp:CustomValidator>
            </td>
            <td>
                <asp:TextBox runat="server" ID="txtUsername" Width="120"></asp:TextBox>*
            </td>
            <td style="width: 100px">
                Pract Type:<asp:CustomValidator ID="validatorType" ValidationGroup="UserProfileForm" runat="server"
                    ClientValidationFunction="ValidateType" ErrorMessage="Please select your Pract Type.">*</asp:CustomValidator>
            </td>
            <td>
               <script type="text/javascript" >
                function showPractType(obj){
                    var txt = document.getElementById("<%=ddlPractTypeValue.ClientID %>");
                    var objS = document.getElementById (obj.id);
                    if(objS.value=="OTHER"){
                        txt.style.display="";
                    }
                    else{
                ...
                <asp:DropDownList ID="ddlPractType" runat="server" onchange="showPractType(this)">
                    <asp:ListItem Value =""></asp:ListItem>
                    <asp:ListItem Value ="MD">MD</asp:ListItem>
                    <asp:ListItem Value ="DENTIST">DENTIST</asp:ListItem>
                    <asp:ListItem Value ="ARNP">ARNP</asp:ListItem>
                    <asp:ListItem Value ="DO">DO</asp:ListItem>
                    <asp:ListItem Value ="OTHER">OTHER</asp:ListItem>
                </asp:DropDownList>
                <asp:TextBox runat="server" ID="ddlPractTypeValue" style="display:none;"></asp:TextBox>
        ...
        <tr>
            <td>
                Password:<asp:RequiredFieldValidator ID="rvPassword" ValidationGroup="UserProfileForm"
                    ControlToValidate="txtPassword" runat="server" ErrorMessage="Please Input Your Password">*</asp:RequiredFieldValidator>
            </td>
            <td>
                <asp:TextBox runat="server" TextMode="Password" ID="txtPassword" Width="120"></asp:TextBox>*
            </td>
            <td>
                Re-enter Password:
                <asp:CustomValidator ID="validatorPassword2" runat="server" ValidationGroup="UserProfileForm"
                    ClientValidationFunction="ValidatePassword" ErrorMessage="Two Passwords Must Match Each Other">*</asp:CustomValidator>
            </td>
            <td>
                <asp:TextBox runat="server" TextMode="Password" ID="txtPassword2" Width="120"></asp:TextBox>*
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td>
                ...
                <asp:RangeValidator ID="rangeBirthDate" runat="server" ControlToValidate="txtBirthDate"
                    ...
                    MinimumValue="1/1/1900" MaximumValue="12/31/2099">*</asp:RangeValidator>
            </td>
            <td>
            ...
            <td>
                <asp:DropDownList runat="server" ID="ddlSex" Width="130">
        ...
        <tr>
            <td>
                Email:<asp:RequiredFieldValidator ID="rvEmail" runat="server" ValidationGroup="UserProfileForm"
                    ErrorMessage="Please Input Your Email." ControlToValidate="txtEmail">*</asp:RequiredFieldValidator><asp:CustomValidator runat="server" ID="reEmail" ControlToValidate="txtEmail"
                ErrorMessage="Invalid Email" ClientValidationFunction="ValidateEmail" ValidationGroup="UserProfileForm">*</asp:CustomValidator>
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="ddlLicenseState" runat="server" Width="130">
        ...
        <tr>
            <td colspan="4">
                <asp:CheckBox ID="cbConsent" runat="server" />I have read, understood, and agreed
                to all the terms and conditions of the <a href="Agreement.html" target="_blank">Client
                    Agreement</a>.*
                <asp:CustomValidator ID="validatorConsent" runat="server" ClientValidationFunction="ValidateConsent"
                    ValidationGroup="UserProfileForm" ErrorMessage="You must agree to all the terms and conditions of the Client Agreement.">*</asp:CustomValidator>
                <br />
        ...
        <tr>
            <td colspan="4" class="center border_top">
                <asp:ImageButton runat="server" ID="btnSubmit" ValidationGroup="UserProfileForm"
                    SkinID="Register" />
            </td>
        </tr>
    </table>
